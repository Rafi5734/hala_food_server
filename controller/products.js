...
const postProducts = expressHandler(async (req, res) => {
  const products = await Products.insertMany({
    ...
    firstImageLink: req.body.firstImageLink,
    secondImageLink: req.body.secondImageLink,
    thirdImageLink: req.body.thirdImageLink,
    fourthImageLink: req.body.fourthImageLink,
    fifthImageLink: req.body.fifthImageLink,
